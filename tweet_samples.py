...
for i in range(11):
	# print(test_chain.generate_tweet(start_with='#god', append_tag=None, append_verse=True, follow=False), '\n_\n')
	print(test_chain.generate_tweet(start_with='usps', append_tag='#MarkovProcess', append_verse=False, follow=False), '\n_\n')
